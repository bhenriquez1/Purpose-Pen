...
const NAV_ITEMS = [
  { href: "/application-management", label: "Overview" },
  { href: "/letter-builder/recommenders", label: "Recommendation Tracker" },
  { href: "/application-management/applicant-profile", label: "Applicant Profile & Packet" },
  { href: "/application-management/committee-packet", label: "Committee Packet" },
  { href: "/application-management/workflow", label: "Checklist & Deadlines" },
];
